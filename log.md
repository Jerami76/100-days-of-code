...
**Today's Progress**: Today I researched and taught myself proper webpage file structure(heirarchy). I applied it to my ToDo List app to make it so that I can store images locally(to the page). Installed Paint.NET to allow image editing to resize original images so that they aren't alwyas being resized by css. Added HTML to index on ToDo List to add elements to flesh out the page.

**Thoughts:** I worked for about an hour today. It's hard getting back into the swing of things. Will try more today. Really happy that I got file structure because I feel like it hasn't been mentioned properly and I was always lost as to how/where to put things. I will need more practice but, getting there.
